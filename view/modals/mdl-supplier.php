<div class="modal fade" id="mdlSupplier" aria-modal="true" role="dialog">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="txtcontacto" name="contacto"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="txtpais" name="pais"
                                    placeholder="País">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="txtregion" name="region"
                                    placeholder="Región">
                            </div>
                            <div class="form-group">
                                <input type="number" class="form-control" id="txtcodigo_postal" name="codigo_postal"
